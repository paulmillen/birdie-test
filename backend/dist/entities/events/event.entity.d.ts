...
export type AllEvents = GeneralObservationEvent | TaskCompletedEvent | FluidIntakeEvent | PhysicalHealthObservationEvent | VisitCompletedEvent | CheckOutEvent | CheckInEvent | MoodObservationEvent | ReguarMedicationTakeEvent | NoMedicationObservationReceivedEvent | AlertRaisedEvent | IncontinencePadObservationEvent;
interface BaseEvent {
    id: string;
    visit_id: string;
    timestamp: string;
